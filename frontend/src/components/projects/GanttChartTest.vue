...
<template>
  <div class="gantt-wrapper" ref="wrapperRef">
    <div class="gantt-toolbar">
      <span class="gantt-title">📅 API Gantt Chart</span>
    ...
    <div v-else-if="!projectStore.ganttAllData.length" class="empty">暂无甘特图数据，请添加 in_progress 或 completed 项目</div>
...
const initializeGantt = () => {
  ...
  try {
    ...
    projectStore.error = '甘特图初始化失败，请检查数据或刷新页面';
  }
};
